...
(* calcul de s (infI, infI') et s' (supI, supI') *)
    ...
    (* Calcul de s sans tri: On remarque que
        ...
        2) c est la version tri�e de b' par la permutation pi' o pi_1
        c) il n'est pas n�cessaire de merger c et e' mais seulement de
           les parcourir en // *)
    (* l: index in e'
       k: index in c
...
(*** (* graphmin sets, version avec arbre binaire � la heap *)
